...
public class AudioReactiveAtmosphereController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // 创建新的材质实例
        atmosphereMaterial = new Material(Shader.Find("Planet/AudioReactiveAtmosphere"));
    ...
    private void Start()
    {
        ...
        if (audioAnalyzer == null)
        {
            ...
            if (audioAnalyzer == null)
            {
                Debug.LogWarning("AudioReactiveAtmosphereController: No AudioAnalyzer found. Audio reaction disabled.");
        ...
        {
            meshFilter.sharedMesh = CreateSphereMesh(1f, 64, 64); // 使用更高的分辨率以获得更好的波动效果
        }
