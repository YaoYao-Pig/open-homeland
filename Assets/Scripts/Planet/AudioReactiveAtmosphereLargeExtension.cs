...
public class AudioReactiveAtmosphereLargeExtension : MonoBehaviour
{
    ...
    private AudioReactiveAtmosphereLargeController atmosphereController;
    ...
    private void SetupAtmosphere()
    {
        ...
        {
            atmosphereObject = new GameObject("AudioReactiveAtmosphereLarge");
            ...
            // 添加所需组件
            atmosphereController = atmosphereObject.AddComponent<AudioReactiveAtmosphereLargeController>();
    ...
    private void ApplySettings()
    {
        if (atmosphereController != null)
        {
            ...
            var waveFrequencyField = atmosphereController.GetType().GetField("waveFrequency", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic);
            if (waveFrequencyField != null) waveFrequencyField.SetValue(atmosphereController, waveFrequency);
            
            var scaleFactorField = atmosphereController.GetType().GetField("scaleFactor", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic);
            if (scaleFactorField != null) scaleFactorField.SetValue(atmosphereController, scaleFactor);
        }
    }
    ...
    public void SetWaveAmplitude(float amplitude)
    {
        ...
        if (atmosphereController != null)
        {
            atmosphereController.SetWaveAmplitude(amplitude);
        }
    }
    ...
    public void SetWaveFrequency(float frequency)
    {
        ...
        if (atmosphereController != null)
        {
            atmosphereController.SetWaveFrequency(frequency);
        }
    }
    ...
    public void SetPulseIntensity(float intensity)
    {
        ...
        if (atmosphereController != null)
        {
            atmosphereController.SetPulseIntensity(intensity);
        }
    }
}
