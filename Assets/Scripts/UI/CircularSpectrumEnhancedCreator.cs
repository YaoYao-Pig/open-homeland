...
public class CircularSpectrumEnhancedCreator : MonoBehaviour
{
    #if UNITY_EDITOR
    [MenuItem("GameObject/UI/Enhanced Circular Audio Spectrum", false, 10)]
    static void CreateEnhancedCircularSpectrum(MenuCommand menuCommand)
    {
        // 创建一个新的游戏对象
        GameObject go = new GameObject("EnhancedCircularAudioSpectrum");
        ...
        CircularSpectrumEnhancedController controller = go.AddComponent<CircularSpectrumEnhancedController>();
        ...
        // 注册撤销
        Undo.RegisterCreatedObjectUndo(go, "Create Enhanced Circular Audio Spectrum");
